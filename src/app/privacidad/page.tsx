    ...
    <div className="min-h-screen bg-ajicolor-light dark:bg-[var(--bg-light)] flex flex-col">
      ...
      <main className="max-w-3xl mx-auto py-16 p-8 flex-1 space-y-8 text-gray-700 dark:text-neutral-300">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-black text-ajicolor-purple dark:text-neutral-100">1. Datos que recopilamos</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-black text-ajicolor-purple dark:text-neutral-100">2. Finalidad del tratamiento</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-black text-ajicolor-purple dark:text-neutral-100">3. Base legal</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-black text-ajicolor-purple dark:text-neutral-100">4. Derechos del titular</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-black text-ajicolor-purple dark:text-neutral-100">5. Seguridad</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-black text-ajicolor-purple dark:text-neutral-100">6. Conservación de datos</h2>
          <p className="text-sm leading-relaxed">
