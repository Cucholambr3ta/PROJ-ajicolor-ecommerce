...
export function GoogleButton({ callbackUrl }: { callbackUrl?: string }) {
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2 border-2 border-ajicolor-ink px-3 py-2.5 text-sm font-bold hover:bg-gray-50 dark:hover:bg-neutral-800"
    >
