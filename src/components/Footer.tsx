...
export function Footer() {
  return (
    <footer className="bg-white border-t-2 border-ajicolor-ink">
      ...
      <div className="border-t border-gray-200 py-6">
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-xs text-gray-400">© {new Date().getFullYear()} Ajicolor. Todos los derechos reservados.</p>
          <p className="text-xs text-gray-400">Compra protegida bajo la Ley 19.496 de Protección al Consumidor (Chile)</p>
        </div>
      </div>
    </footer>
  );
